...
//		String input = "01010011 01010101 01001101";
 		String input = "010100110101010101001101"; //No spaces
		String ASCII = "SUM";
		String ASCII2 = "WEI";
		//Act
	...
	@Test
	public void BinaryToASCII_WhenInputIsNotNull() {
		//Arrange
		String input = "00000000";
		//Act
		//Assert
			String ASCII = RecursiveOperations2.ConvertBinaryToASCII(input);
			assertTrue("input is not null", false);
	}
...
//	//Throws IAE when input contains a negative sign
	...
	public void convertAnythingToBase10ValidInt() {
		...
		//Act
		double ans = RecursiveOperations2.AnythingToBase10("101", 5);
		//Assert
	...
	@Test
	public void rgbValidInputs() {
	String answer = "#172c01";
			
	String x = RecursiveOperations2.ConvertStringToRGB("23", "44", "1");
	assertEquals(answer, x);
	}
	@Test
	public void rgbInvalidInputs() {
	String answer = "#172c01";

	assertThrows(IllegalArgumentException.class, () -> {
		String x = RecursiveOperations2.ConvertStringToRGB("2333", "32", "1");
	});	
	}
	@Test
	public void rgbInvalidInputs2() {
	String answer = "#172c01";

	assertThrows(IllegalArgumentException.class, () -> {
		String x = RecursiveOperations2.ConvertStringToRGB("2333", "1132", "1");
	});	
	}
	@Test
	public void rgbInvalidInputs3() {
	String answer = "#172c01";

	assertThrows(IllegalArgumentException.class, () -> {
		String x = RecursiveOperations2.ConvertStringToRGB("2333", "32", "1999");
	});	
	}
	@Test
	public void rgbNullInputs() {
	String answer = "#172c01";

	assertThrows(IllegalArgumentException.class, () -> {
		String x = RecursiveOperations2.ConvertStringToRGB(null, "1", "2");
	});	
	}
	@Test
	public void rgbNullInputs2() {
	String answer = "#172c01";

	assertThrows(IllegalArgumentException.class, () -> {
		String x = RecursiveOperations2.ConvertStringToRGB(null, null, "2");
	});	
	}
	@Test
	public void rgbNullInputs3() {
	assertThrows(IllegalArgumentException.class, () -> {
		String x = RecursiveOperations2.ConvertStringToRGB(null, null, null);
	});	
	}
	/*
	 * ARGB
	 */
	@Test
	public void argbValidInputs() {
	String answer = "02172c01";
			
	String x = RecursiveOperations2.ConvertStringToARGB("23", "44", "1", "2");
	System.out.println(x);
	assertEquals(answer, x);
	}
	@Test
	public void argbInvalidInputs() {

	assertThrows(IllegalArgumentException.class, () -> {
		String x = RecursiveOperations2.ConvertStringToARGB("2333", "32", "1", "2");
	});	
	}
	@Test
	public void argbInvalidInputs2() {


	assertThrows(IllegalArgumentException.class, () -> {
		String x = RecursiveOperations2.ConvertStringToARGB("2333", "1132", "1", "2");
	});	
	}
	@Test
	public void argbInvalidInputs3() {


	assertThrows(IllegalArgumentException.class, () -> {
		String x = RecursiveOperations2.ConvertStringToARGB("2333", "32", "1999", "2");
	});	
	}
	@Test
	public void argbInvalidInputs4() {

	assertThrows(IllegalArgumentException.class, () -> {
		String x = RecursiveOperations2.ConvertStringToARGB("2333", "32", "1999", "992");
	});	
	}
	@Test
	public void argbNullInputs() {

	assertThrows(IllegalArgumentException.class, () -> {
		String x = RecursiveOperations2.ConvertStringToARGB(null, "1", "2", "2");
	});	
	}
	@Test
	public void argbNullInputs2() {
	
	assertThrows(IllegalArgumentException.class, () -> {
		String x = RecursiveOperations2.ConvertStringToARGB(null, null, "2", "2");
	});	
	}
	@Test
	public void argbNullInputs3() {
	assertThrows(IllegalArgumentException.class, () -> {
		String x = RecursiveOperations2.ConvertStringToARGB(null, null, null, "2");
	});	
	}
	@Test
	public void argbNullInputs4() {
	assertThrows(IllegalArgumentException.class, () -> {
		String x = RecursiveOperations2.ConvertStringToARGB(null, null, null, null);
	});	
	}
}
